class NavSystem extends BaseInstrument {
    ...
    connectedCallback() {
        ...
        this.currFlightPlanManager = new Aims.FlightPlanManager(this);
        this.currFlightPlan = new Aims.ManagedFlightPlan();
        this.currFlightPhaseManager = Aims.getFlightPhaseManager();
    }
    ...
    onInteractionEvent(_args) {
        if (this.isElectricityAvailable() || SimVar.GetSimVarValue("L:B77HS_ELEC_DC_ESS_BUS_IS_POWERED", "Bool")) {
                ...
                if (value) {
                    switch (message.Type) {
                        ...
                        case Annunciation_MessageType.CAUTION:
                            ...
                            let fuelSwitches = 0;
                            if (SimVar.GetSimVarValue("FUELSYSTEM VALVE SWITCH:" + 3, "bool")) {
                                fuelSwitches++;
                            }
                            if (SimVar.GetSimVarValue("FUELSYSTEM VALVE SWITCH:" + 4, "bool")) {
                                fuelSwitches++;
                            }
...
class Engine_Annunciations extends Cabin_Annunciations {
    ...
    parkBrake() {
        return SimVar.GetSimVarValue("L:B77RS_PARK_BRAKE_LEVER_POS", "Bool");
    }
    oxygen() {
        return false;
    }
...
class Warnings extends NavSystemElement {
    ...
    landingGearCallback() {
        ...
        const flaps = SimVar.GetSimVarValue("L:B77HS_FLAPS_HANDLE_INDEX", "number");
