...
class NXLogic_TriggeredMonostableNode {
    ...
    write(value, _deltaTime) {
        if (this._previousValue === null && SimVar.GetSimVarValue("L:B77HS_FWC_SKIP_STARTUP", "Bool")) {
...
class NXLogic_ConfirmNode {
    ...
    write(value, _deltaTime) {
        if (this._previousInput === null && SimVar.GetSimVarValue("L:B77HS_FWC_SKIP_STARTUP", "Bool")) {
