...
(function (Airliners) {
        ...
        changePage(_pageName) {
            ...
            for (let i = 0; i < this.lowerScreenPages.length; i++) {
                if (this.lowerScreenPages[i].name == pageName) {
                    SimVar.SetSimVarValue("L:B77HS_ECAM_SD_CURRENT_PAGE_INDEX", "number", i);
                    break;
                }
            }
        }
    ...
    class EICASScreen extends NavSystemElementContainer {
        constructor(_name, _root, _selector) {
            ...
            this.getDeltaTime = B77HS_Util.createDeltaTimeCalculator(this._lastTime);
        }
        init() {
            super.init();
    ...
    class BaseATC extends BaseAirliners {
        ...
        onUpdate(_deltaTime) {
            ...
            const lightsTest = SimVar.GetSimVarValue("L:B77HS_OVHD_INTLT_ANN", "number") == 0;
