...
class Jet_NDCompass extends HTMLElement {
    ...
    updateCompass(_deltaTime) {
        ...
        if (this.displayMode !== Jet_NDCompass_Display.PLAN) {
            ...
            const desiredRotationHeading = SimVar.GetSimVarValue("L:B77HS_ADIRU_STATE", "Number") !== 2
                ? 0
                : compass;
        ...
        if (this.referenceMode == Jet_NDCompass_Reference.HEADING) {
            ...
            } else if (this.aircraft == Aircraft.B747_8 || this.aircraft == Aircraft.AS01B || this.aircraft == Aircraft.B777 || this.aircraft == Aircraft.B767) {
                var selectedHeading = simSelectedHeading;
