class Jet_PFD_GPWSIndicator extends HTMLElement {
    constructor() {
        super(...arguments);
        this.warningText = nul;
        this.warningPosX = 0;
        this.warningPosY = 0;
    ...
    construct_B747_8() {
        ...
        this.centerGroup.setAttribute("id", "WarningGroup");
...
customElements.define("jet-pfd-gpws-indicator", Jet_PFD_GPWSIndicator);
//# sourceMappingURL=GPWSIndicator.js.map