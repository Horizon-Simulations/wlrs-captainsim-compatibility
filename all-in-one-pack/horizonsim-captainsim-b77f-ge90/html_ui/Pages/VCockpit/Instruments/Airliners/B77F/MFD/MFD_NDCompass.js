class Jet_MFD_NDCompass extends Jet_NDCompass {
    ...
    constructArc_B777() {
        ...
        this.root.appendChild(trsGroup);
        {
            ...
            viewBox.appendChild(this.rotatingCircle);
            {
                ...
                circleGroup.setAttribute("id", "circleGroup");
                {
                    ...
                    for (let i = 0; i < dashSpacing; i++) {
                        ...
                        if (bIsBig) {
                            //number under/in the circle
                            this.textHeading = document.createElementNS(Avionics.SVG.NS, "text");
                            this.textHeading.textContent = (i % 3 == 0) ? fastToFixed(degrees / 10, 0) : "";
                            this.textHeading.setAttribute("x", "50");
                            this.textHeading.setAttribute("y", (-(circleRadius - 45 - length - 18)).toString());
                            this.textHeading.setAttribute("fill", "white");
                            this.textHeading.setAttribute("font-size", (i % 3 == 0) ? "28" : "20");
                            this.textHeading.setAttribute("font-family", "BoeingEFIS");
                            this.textHeading.setAttribute("text-anchor", "middle");
                            this.textHeading.setAttribute("alignment-baseline", "central");
                            this.textHeading.setAttribute("transform", "rotate(" + degrees + " 50 50)");
                        }
                        circleGroup.appendChild(this.textHeading);
                ...
                this.rotatingCircle.appendChild(this.selectedHeadingGroup);         //crucial
            ...
            }
            {
                ...
                this.rangeGroup = document.createElementNS(Avionics.SVG.NS, "g");
                this.rangeGroup.setAttribute("id", "RangeGroup");
                this.rangeGroup.setAttribute("transform", "scale(0.8)");
                {
                    let centerX = -95;
                    let centerY = -540;
                    ...
                    this.rangeGroup.appendChild(textBg);
                    ...
                    this.rangeGroup.appendChild(textTitle);
                    this.addMapRange(this.rangeGroup, centerX, (centerY + 15), "white", "25", false, 1.0, false);
                }
                viewBox.appendChild(this.rangeGroup);
            }
        }
    }
    updateIRS() {
        ...
        if (IRSState == 0) {
            if (this.displayMode === Jet_NDCompass_Display.ARC) {
                ...
                this.rangeGroup.setAttribute("display", "none");
        ...
        if (IRSState == 2) {
            if (this.displayMode === Jet_NDCompass_Display.ARC) {
                ...
                this.currentRefMode.setAttribute("display", "");
                this.rotatingCircle.setAttribute("display", "");
                this.rangeGroup.setAttribute("display", "");
                this.textHeading.setAttribute("display", "");   //not working for some reason, check this later 
            }
        }
    }
    ...
    constructPlan_B777() {
        ...
        this.appendChild(this.root);
        {
            ...
            this.rangeGroup = document.createElementNS(Avionics.SVG.NS, "g");
            this.rangeGroup.setAttribute("id", "RangeGroup");
            this.rangeGroup.setAttribute("transform", "scale(1.25)");
            {
                let centerX = 245;
                let centerY = 48;
                let textBg = document.createElementNS(Avionics.SVG.NS, "rect");
            ...
            this.root.appendChild(this.rangeGroup);
        }
    }
    constructPlan_AS01B() {
    }
