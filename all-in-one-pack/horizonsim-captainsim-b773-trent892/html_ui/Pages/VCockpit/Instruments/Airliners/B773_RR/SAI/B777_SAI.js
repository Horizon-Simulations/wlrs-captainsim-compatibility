    ...
    constructor() {
        ...
        this.construct = () => {
                ...
                this.line = document.createElementNS(Avionics.SVG.NS, "text");
            {
                ...
                this.line.setAttribute("font-family", "BoeingEFIS");
...
class B777_SAI_AirspeedIndicator extends HTMLElement {
    ...
    construct() {
        ...
        this.cursorSVG.setAttribute("viewBox", "0 0 " + cursorWidth + " " + cursorHeight);
        {
            ...
            this.cursorIntegrals[0].construct(this.cursorSVG, _cursorPosX - 30, _cursorPosY, _width, "BoeingEFIS", this.fontSize, "white");
            this.cursorIntegrals[1].construct(this.cursorSVG, _cursorPosX - 17, _cursorPosY, _width, "BoeingEFIS", this.fontSize, "white");
            this.cursorDecimals.construct(this.cursorSVG, _cursorPosX - 2, _cursorPosY, _width, "BoeingEFIS", this.fontSize, "white");
...
class B777_SAI_AltimeterIndicator extends HTMLElement {
    ...
    construct() {
        ...
        this.cursorSVG.setAttribute("viewBox", "0 0 " + cursorWidth.toString() + " " + cursorHeight.toString());
        {
            ...
            var _cursorPosY = cursorHeight * 0.5;
            this.cursorIntegrals[0].construct(this.cursorSVG, _cursorPosX - 55, _cursorPosY, _width, "BoeingEFIS", this.fontSize, "white");
            this.cursorIntegrals[1].construct(this.cursorSVG, _cursorPosX - 40, _cursorPosY, _width, "BoeingEFIS", this.fontSize, "white");
            this.cursorIntegrals[2].construct(this.cursorSVG, _cursorPosX - 25, _cursorPosY, _width, "BoeingEFIS", this.fontSize, "white");
            this.cursorDecimals.construct(this.cursorSVG, _cursorPosX, _cursorPosY, _width, "BoeingEFIS", this.fontSize * 0.75, "white");
