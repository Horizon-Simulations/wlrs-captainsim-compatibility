class HorizonSimJettison {
    constructor() {
        ...
        this.knobPosToAction = {
            ...
            1: (knobMoved) => {
                ...
                SimVar.SetSimVarValue("L:B777_FUEL_TO_REMAIN", "TYPE_FLOAT64", this.mlwFuel);
            ...
            0: (knobMoved) => {
                if (knobMoved) {
                    ...
                    this.jettFuelTarget = SimVar.GetSimVarValue("L:B777_FUEL_TO_REMAIN", "TYPE_FLOAT64");
                }
                ...
                SimVar.SetSimVarValue("L:B777_FUEL_TO_REMAIN", "TYPE_FLOAT64", this.jettFuelTarget);
    ...
    update() {
        ...
        SimVar.SetSimVarValue("L:B777_FUEL_JETTISON_ACTIVE_L", "Enum", publishL);
        SimVar.SetSimVarValue("L:B777_FUEL_JETTISON_ACTIVE_R", "Enum", publishR);
    }
    ...
    runJettison(jettType) {
        ...
        if (flowRatePerMin <= 0.000001) {
            SimVar.SetSimVarValue("L:B777_JETTISON_MIN_REMAINING", "TYPE_FLOAT64", 999);
            return;
        }
        ...
        SimVar.SetSimVarValue("L:B777_JETTISON_MIN_REMAINING", "TYPE_FLOAT64", Math.min(minRemaining, 999));
