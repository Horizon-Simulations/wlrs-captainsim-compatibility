class HorizonSimBoarding {
    ...
    static async setTargetPax(numberOfPax) {
        ...
        //calibrate later 
        await fillStation(paxStations["rearEconomy"], 0.41, numberOfPax);
        await fillStation(paxStations["forwardEconomy"], 0.385, numberOfPax);
        await fillStation(paxStations["premiumEconomy"], 0.13, numberOfPax);
        await fillStation(paxStations["businessClass"], 1, paxRemaining);
        //
    }
