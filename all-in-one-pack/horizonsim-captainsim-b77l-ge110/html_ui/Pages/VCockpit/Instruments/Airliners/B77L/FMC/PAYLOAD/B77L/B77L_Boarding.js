class HorizonSimBoarding {
    ...
    static async setTargetPax(numberOfPax) {
        ...
        await fillStation(paxStations["businessClass"], 0.15, numberOfPax);
        await fillStation(paxStations["forwardEconomy"], 0.34, numberOfPax);
        await fillStation(paxStations["rearEconomy"], 0.475, numberOfPax);
    ...
    static async setTargetCargo(cargo) {
        ...
        await fillCargo(cargoStations["fwdBag"], 0.50, loadableCargoWeight);
        await fillCargo(cargoStations["aftBag"], 0.42, loadableCargoWeight);
